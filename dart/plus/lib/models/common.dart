...
class AccountType implements Comparable<AccountType> {
  ...
  String toString() {
    switch (this) {
      ...
      case ROTH_IRS401K:
        return "RothIrs401k";
      case TRADITIONAL_IRS401K:
        return "TraditionalIrs401k";
      case COLLEGE_IRS529:
        return "CollegeIrs529";
  ...
  static AccountType fromString(String s) {
    ...
    switch (s) {
      ...
      case "RothIrs401k":
        return ROTH_IRS401K;
      case "TraditionalIrs401k":
        return TRADITIONAL_IRS401K;
      case "CollegeIrs529":
        return COLLEGE_IRS529;
      case "TraditionalIra":
...
class AssetType implements Comparable<AssetType> {
  ...
  String toString() {
    switch (this) {
      ...
      case FAMILY_PROPERTY:
        return "FamilyProperty";
      case FINANCIAL_INSTRUMENT:
        return "FinancialInstrument";
      case AUTOMOBILE:
        return "Automobile";
      case LIFE_INSURANCE_POLICY:
        return "LifeInsurancePolicy";
      case COMPANY_STOCK_OPTION:
        return "CompanyStockOption";
      case SAVINGS:
        return "Savings";
      case COLLEGE_SAVINGS:
        return "CollegeSavings";
  ...
  static AssetType fromString(String s) {
    ...
    switch (s) {
      ...
      case "Automobile":
        return AUTOMOBILE;
      case "LifeInsurancePolicy":
        return LIFE_INSURANCE_POLICY;
      case "CompanyStockOption":
        return COMPANY_STOCK_OPTION;
      case "Savings":
        return SAVINGS;
      case "CollegeSavings":
        return COLLEGE_SAVINGS;
...
class HoldingType implements Comparable<HoldingType> {
  ...
  static get values => [OTHER, STOCK, BOND, CASH, BLEND];
...
class InterpolationType implements Comparable<InterpolationType> {
  ...
  static get values => [LINEAR, STEP, CUBIC];
...
class TaxCategory implements Comparable<TaxCategory> {
  ...
  String toString() {
    switch (this) {
      ...
      case UNQUALIFIED_DIVIDEND_INCOME:
        return "UnqualifiedDividendIncome";
      ...
      case OTHER_ORDINARY_INCOME:
        return "OtherOrdinaryIncome";
      case INHERITANCE:
        return "Inheritance";
      case RENTAL_INCOME:
        return "RentalIncome";
  ...
  static TaxCategory fromString(String s) {
    ...
    switch (s) {
      ...
      case "UnqualifiedDividendIncome":
        return UNQUALIFIED_DIVIDEND_INCOME;
...
class TaxingAuthority implements Comparable<TaxingAuthority> {
  ...
  static get values => [FEDERAL, STATE];
...
class Point {
  ...
  bool operator ==(Point other) =>
      identical(this, other) || x == other.x && y == other.y;
...
class CostBasis {
  CostBasis(this.units, this.unitValue) {
    _init();
  }
...
class QuantityBin {
  ...
  static QuantityBin fromJson(Object json) {
    ...
    assert(json is Map);
    return new QuantityBin().._fromJsonMapImpl(json);
  }
...
QuantityBin quantityBin() => new QuantityBin();
...
class CFlowSequenceSpec {
  ...
  static CFlowSequenceSpec fromJson(Object json) {
    ...
    assert(json is Map);
    return new CFlowSequenceSpec().._fromJsonMapImpl(json);
  }
...
CFlowSequenceSpec cFlowSequenceSpec() => new CFlowSequenceSpec();
