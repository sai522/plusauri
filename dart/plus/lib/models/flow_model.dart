...
class FlowSpec {
  ...
  bool operator ==(FlowSpec other) => identical(this, other) ||
      descr == other.descr &&
          source == other.source &&
  ...
  FlowSpec._fromJsonMapImpl(Map jsonMap)
      : descr = jsonMap["descr"],
        ...
        cFlowSequenceSpec = CFlowSequenceSpec
            .fromJson(jsonMap["cFlowSequenceSpec"]);
...
class FlowKey {
  ...
  bool operator ==(FlowKey other) => identical(this, other) ||
      name == other.name && isIncome == other.isIncome;
...
class FlowTypeKey {
  ...
  Map toJson() => {"flowType": ebisu_utils.toJson(flowType),};
...
class IncomeSpec {
  ...
  bool operator ==(IncomeSpec other) => identical(this, other) ||
...
class ExpenseSpec {
  ...
  bool operator ==(ExpenseSpec other) => identical(this, other) ||
...
class FlowModel {
  ...
  RealizedFlows expand(DateRange dateRange) => new RealizedFlows(
  ...
  List<FlowKey> get incomeKeys {
    if (_incomeKeys == null) {
      _incomeKeys = new List<FlowKey>.from(
          incomeModel.keys.map((key) => new FlowKey(key, true)));
    }
    return _incomeKeys;
  }
  ...
  FlowModel._fromJsonMapImpl(Map jsonMap)
      ...
      incomeModel = ebisu_utils.constructMapFromJsonData(
          jsonMap["incomeModel"], (value) => IncomeSpec.fromJson(value)),
        // expenseModel is Map<String,ExpenseSpec>
        expenseModel = ebisu_utils.constructMapFromJsonData(
            jsonMap["expenseModel"], (value) => ExpenseSpec.fromJson(value));

  FlowModel._copy(FlowModel other)
      : incomeModel = valueApply(
          other.incomeModel, (v) => v == null ? null : v.copy()),
        expenseModel = valueApply(
            other.expenseModel, (v) => v == null ? null : v.copy()),
        _incomeKeys = other._incomeKeys == null
            ? null
            : (new List.from(
                other._incomeKeys.map((e) => e == null ? null : e.copy()))),
        _expenseKeys = other._expenseKeys == null
            ? null
            : (new List.from(
                other._expenseKeys.map((e) => e == null ? null : e.copy())));
...
class IncomeFlows {
  ...
  bool operator ==(IncomeFlows other) => identical(this, other) ||
  ...
  filterOnYear(int year) => new IncomeFlows(
      incomeType, new TimeSeries.fromIterable(timeSeries.filterOnYear(year)));
...
class ExpenseFlows {
  ...
  bool operator ==(ExpenseFlows other) => identical(this, other) ||
  ...
  filterOnYear(int year) => new ExpenseFlows(
      expenseType, new TimeSeries.fromIterable(timeSeries.filterOnYear(year)));
...
class RealizedFlows {
  ...
  bool operator ==(RealizedFlows other) => identical(this, other) ||
      const MapEquality().equals(incomeFlows, other.incomeFlows) &&
          const MapEquality().equals(expenseFlows, other.expenseFlows);

  int get hashCode => hash2(const MapEquality().hash(incomeFlows),
  ...
  double netFlowsOn(Date asOf,
      {RateCurve incomeCurve, RateCurve expenseCurve}) {
  ...
  filterOnYear(int year) => new RealizedFlows.courtesy(_filteredFlows(
          incomeFlows, (IncomeFlows flows) => flows.filterOnYear(year)),
      _filteredFlows(
          expenseFlows, (ExpenseFlows flows) => flows.filterOnYear(year)));
  ...
  RealizedFlows._fromJsonMapImpl(Map jsonMap)
      ...
      incomeFlows = ebisu_utils.constructMapFromJsonData(
          jsonMap["incomeFlows"], (value) => IncomeFlows.fromJson(value)),
        // expenseFlows is Map<String,ExpenseFlows>
        expenseFlows = ebisu_utils.constructMapFromJsonData(
            jsonMap["expenseFlows"], (value) => ExpenseFlows.fromJson(value));

  RealizedFlows._copy(RealizedFlows other)
      : incomeFlows = valueApply(
          other.incomeFlows, (v) => v == null ? null : v.copy()),
        expenseFlows = valueApply(
            other.expenseFlows, (v) => v == null ? null : v.copy());
}
