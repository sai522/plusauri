...
class ReturnUnfavorableSequence implements ScenarioGenerator {
  ...
  AssumptionModel generateScenario(
      Dossier _, AssumptionModel assumptionModel) => null;
...
_visitBalanceSheetCurves(
    BalanceSheetAssumptions assumptions, CurveAdjuster curveAdjuster) {
  ...
  builder.assetAssumptions = valueApply(
      builder.assetAssumptions, (RateCurve curve) => curveAdjuster(curve));
