...
class _Dossiers {
  ...
  static _createInstrumentAssumptions(holdingReturns, [instrumentPartitions]) {
    final result = new InstrumentAssumptions(
        HoldingType.STOCK,
        holdingReturns,
  ...
  static get _ibmAssumptions =>
      _createInstrumentAssumptions(new HoldingReturns({
  ...
  static get _ibmDripAssumptions =>
      _createInstrumentAssumptions(new HoldingReturns({
    HoldingReturnType.CAPITAL_APPRECIATION: _curves.stockReturn,
    HoldingReturnType.QUALIFIED_DIVIDEND: _curves.qualifiedDivReturn,
    HoldingReturnType.UNQUALIFIED_DIVIDEND: _curves.unqualifiedDivReturn,
  ...
  static get _msftQdripAssumptions =>
      _createInstrumentAssumptions(new HoldingReturns({
    HoldingReturnType.CAPITAL_APPRECIATION: RateCurve.merge(
        _curves.stockReturn,
        _curves.unqualifiedDivReturn),
  ...
  get middleIncome {
    var result = (new DossierBuilder()
        ...
        ..assumptionModel = new AssumptionModel(
            _curves.inflation,
        ...
        ..fundingLinks = {
          'economicChildCollege': 'college junior'
        }
        ..investmentLinks = {});
