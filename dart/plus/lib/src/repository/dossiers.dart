...
class _Dossiers {
  static _createInstrumentAssumptions(holdingReturns, [instrumentPartitions]) {
    final result = new InstrumentAssumptions(HoldingType.STOCK, holdingReturns,
        instrumentPartitions == null
            ? DefaultSingleStockPartitions
  ...
  static get _ibmDripAssumptions => _createInstrumentAssumptions(
      new HoldingReturns({
    HoldingReturnType.CAPITAL_APPRECIATION: _curves.stockReturn,
    HoldingReturnType.QUALIFIED_DIVIDEND: _curves.qualifiedDivReturn,
    HoldingReturnType.UNQUALIFIED_DIVIDEND: _curves.unqualifiedDivReturn,
  ...
  static get _msftAssumptions => _createInstrumentAssumptions(
      new HoldingReturns({
    HoldingReturnType.CAPITAL_APPRECIATION:
        RateCurve.merge(_curves.stockReturn, _curves.unqualifiedDivReturn),
    HoldingReturnType.QUALIFIED_DIVIDEND: _curves.qualifiedDivReturn,
  }));

  static get _msftQdripAssumptions => _createInstrumentAssumptions(
      new HoldingReturns({
    HoldingReturnType.CAPITAL_APPRECIATION:
        RateCurve.merge(_curves.stockReturn, _curves.unqualifiedDivReturn),
    HoldingReturnType.QUALIFIED_DIVIDEND: _curves.qualifiedDivReturn,
  ...
  static get _nodivAssumptions => _createInstrumentAssumptions(
      new HoldingReturns({
    HoldingReturnType.CAPITAL_APPRECIATION: RateCurve.merge(
        RateCurve.merge(_curves.stockReturn, _curves.qualifiedDivReturn),
        _curves.unqualifiedDivReturn)
  }));
  ...
  get middleIncome {
    var result = (new DossierBuilder()
      ...
      ..assumptionModel = new AssumptionModel(_curves.inflation,
          new BalanceSheetAssumptions(// Asset Assumptions
              {
        ...
        'collegeEducationPurchase': _curves.stateCollegeCostIncreases,
          ...
          {
        'etrade': new AccountAssumptions(_ibmAssumptions,
            // defaultInstrumentAssumptions
            null, // defaultReinvestmentPolicy
            // HoldingReinvestmentPolicies
            {'ibm': ReinvestForCashFlow, 'msft': ReinvestForCashFlow,})
      ...
      }), {}, {}, {}, DefaultStrategyAssumptions, DefaultTaxRateAssumptions,
  ...
  get all => {'middleIncome': middleIncome,};
}
