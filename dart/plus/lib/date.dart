...
class Date
  ...
  Date get nextDay => new Date.fromDateTime(_dateTime.add(const Duration(days: 1)));
  Date get nextYear => new Date(_dateTime.year + 1, _dateTime.month, _dateTime.day);
  Date get priorDay => new Date.fromDateTime(_dateTime.add(const Duration(days: -1)));
