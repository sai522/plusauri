...
class HoldingReturnType implements Comparable<HoldingReturnType> {
  ...
  String toString() {
    switch(this) {
      ...
      case UNQUALIFIED_DIVIDEND: return "UnqualifiedDividend";
      case CAPITAL_GAIN_DISTRIBUTION: return "CapitalGainDistribution";
      case CAPITAL_APPRECIATION: return "CapitalAppreciation";
    }
    return null;
  }
  ...
  static HoldingReturnType fromString(String s) {
    ...
    switch(s) {
      ...
      case "UnqualifiedDividend": return UNQUALIFIED_DIVIDEND;
      case "CapitalGainDistribution": return CAPITAL_GAIN_DISTRIBUTION;
      case "CapitalAppreciation": return CAPITAL_APPRECIATION;
      default: return null;
    }
  }
...
class LiquidationSortType implements Comparable<LiquidationSortType> {
  ...
  String toString() {
    switch(this) {
      case SELL_FARTHEST_PARTITION: return "SellFarthestPartition";
      case SELL_LARGEST_GAINER: return "SellLargestGainer";
    }
    return null;
  }
  ...
  static LiquidationSortType fromString(String s) {
    if(s == null) return null;
    switch(s) {
      case "SellFarthestPartition": return SELL_FARTHEST_PARTITION;
      case "SellLargestGainer": return SELL_LARGEST_GAINER;
      default: return null;
    }
  }
...
class InvestmentSortType implements Comparable<InvestmentSortType> {
  ...
  String toString() {
    switch(this) {
      case BUY_CLOSEST_PARTITION: return "BuyClosestPartition";
      case BUY_LARGEST_LOSER: return "BuyLargestLoser";
    }
    return null;
  }
  ...
  static InvestmentSortType fromString(String s) {
    if(s == null) return null;
    switch(s) {
      case "BuyClosestPartition": return BUY_CLOSEST_PARTITION;
      case "BuyLargestLoser": return BUY_LARGEST_LOSER;
      default: return null;
    }
  }
...
class HoldingReturns {
  ...
  HoldingReturns._copy(HoldingReturns other) :
    returns = valueApply(other.returns, (v) =>
      v == null? null : v.copy());
...
class InstrumentAssumptions {
  ...
  InstrumentAssumptions._fromJsonMapImpl(Map jsonMap) :
    ...
    instrumentPartitions = InstrumentPartitions.fromJson(jsonMap["instrumentPartitions"]);

  InstrumentAssumptions._copy(InstrumentAssumptions other) :
    holdingType = other.holdingType == null? null : other.holdingType.copy(),
    holdingReturns = other.holdingReturns == null? null : other.holdingReturns.copy(),
    instrumentPartitions = other.instrumentPartitions == null? null : other.instrumentPartitions.copy();
...
class AccountAssumptions {
  ...
  bool operator==(AccountAssumptions other) =>
    ...
    const MapEquality().equals(holdingReinvestmentPolicies, other.holdingReinvestmentPolicies);

  int get hashCode => hash3(otherInstrumentAssumptions, defaultReinvestmentPolicy, const MapEquality().hash(holdingReinvestmentPolicies));
  ...
  Map toJson() => {
      "otherInstrumentAssumptions": ebisu_utils.toJson(otherInstrumentAssumptions),
      "defaultReinvestmentPolicy": ebisu_utils.toJson(defaultReinvestmentPolicy),
      "holdingReinvestmentPolicies": ebisu_utils.toJson(holdingReinvestmentPolicies),
  };
  ...
  AccountAssumptions._fromJsonMapImpl(Map jsonMap) :
    otherInstrumentAssumptions = InstrumentAssumptions.fromJson(jsonMap["otherInstrumentAssumptions"]),
    defaultReinvestmentPolicy = ReinvestmentPolicy.fromJson(jsonMap["defaultReinvestmentPolicy"]),
    // holdingReinvestmentPolicies is Map<String,ReinvestmentPolicy>
    holdingReinvestmentPolicies = ebisu_utils
      .constructMapFromJsonData(
  ...
  AccountAssumptions._copy(AccountAssumptions other) :
    otherInstrumentAssumptions = other.otherInstrumentAssumptions == null? null : other.otherInstrumentAssumptions.copy(),
    defaultReinvestmentPolicy = other.defaultReinvestmentPolicy == null? null : other.defaultReinvestmentPolicy.copy(),
    holdingReinvestmentPolicies = valueApply(other.holdingReinvestmentPolicies, (v) =>
      v == null? null : v.copy());

}

class BalanceSheetAssumptions {
  const BalanceSheetAssumptions(this.assetAssumptions, this.liabilityAssumptions,
    this.accountAssumptions, this.instrumentAssumptions);
  ...
  BalanceSheetAssumptions._fromJsonMapImpl(Map jsonMap) :
    ...
    instrumentAssumptions = ebisu_utils
      .constructMapFromJsonData(
  ...
  BalanceSheetAssumptions._copy(BalanceSheetAssumptions other) :
    assetAssumptions = valueApply(other.assetAssumptions, (v) =>
      v == null? null : v.copy()),
    liabilityAssumptions = valueApply(other.liabilityAssumptions, (v) =>
      v == null? null : v.copy()),
    accountAssumptions = valueApply(other.accountAssumptions, (v) =>
      v == null? null : v.copy()),
    instrumentAssumptions = valueApply(other.instrumentAssumptions, (v) =>
      v == null? null : v.copy());
...
class StrategyAssumptions {
  ...
  int get hashCode => hash4(targetPartitions,
    emergencyReserves,
    liquidationSortType,
    investmentSortType);

  copy() => new StrategyAssumptions()
    ..targetPartitions = targetPartitions == null? null : targetPartitions.copy()
    ..emergencyReserves = emergencyReserves
    ..liquidationSortType = liquidationSortType == null? null : liquidationSortType.copy()
    ..investmentSortType = investmentSortType == null? null : investmentSortType.copy();
  ...
  static StrategyAssumptions fromJson(Object json) {
    ...
    assert(json is Map);
    return new StrategyAssumptions()
      .._fromJsonMapImpl(json);
  }

  void _fromJsonMapImpl(Map jsonMap) {
    targetPartitions = InstrumentPartitions.fromJson(jsonMap["targetPartitions"]);
    emergencyReserves = jsonMap["emergencyReserves"];
    liquidationSortType = LiquidationSortType.fromJson(jsonMap["liquidationSortType"]);
    investmentSortType = InvestmentSortType.fromJson(jsonMap["investmentSortType"]);
  }
}
...
class TaxRateAssumptions {
  ...
  TaxRateAssumptions._fromJsonMapImpl(Map jsonMap) :
    ...
    socialSecurityIncome = RateCurve.fromJson(jsonMap["socialSecurityIncome"]),
  ...
  TaxRateAssumptions._copy(TaxRateAssumptions other) :
    pensionIncome = other.pensionIncome == null? null : other.pensionIncome.copy(),
    socialSecurityIncome = other.socialSecurityIncome == null? null : other.socialSecurityIncome.copy(),
    capitalGains = other.capitalGains == null? null : other.capitalGains.copy(),
    dividends = other.dividends == null? null : other.dividends.copy(),
    rentalIncome = other.rentalIncome == null? null : other.rentalIncome.copy(),
    ordinaryIncome = other.ordinaryIncome == null? null : other.ordinaryIncome.copy();
...
class AssumptionModel {
  AssumptionModel(this.inflation, this.balanceSheetAssumptions,
    ...
    this.strategyAssumptions, this.taxRateAssumptions, this.reserveAssumptions) { _init(); }
  ...
  bool operator==(AssumptionModel other) =>
    ...
    const MapEquality().equals(expenseModelOverrides, other.expenseModelOverrides) &&
  ...
  AssumptionModel._fromJsonMapImpl(Map jsonMap) :
    ...
    balanceSheetAssumptions = BalanceSheetAssumptions.fromJson(jsonMap["balanceSheetAssumptions"]),
    // incomeModelOverrides is Map<String,IncomeSpec>
    incomeModelOverrides = ebisu_utils
      .constructMapFromJsonData(
        jsonMap["incomeModelOverrides"],
        (value) => IncomeSpec.fromJson(value)),
    // expenseModelOverrides is Map<String,ExpenseSpec>
    expenseModelOverrides = ebisu_utils
      .constructMapFromJsonData(
        jsonMap["expenseModelOverrides"],
        (value) => ExpenseSpec.fromJson(value)),
    // dateAssumptions is Map<String,DateAssumptions>
    dateAssumptions = ebisu_utils
      .constructMapFromJsonData(
        jsonMap["dateAssumptions"],
        (value) => DateAssumptions.fromJson(value)),
    strategyAssumptions = StrategyAssumptions.fromJson(jsonMap["strategyAssumptions"]),
    taxRateAssumptions = TaxRateAssumptions.fromJson(jsonMap["taxRateAssumptions"]),
    reserveAssumptions = ReserveAssumptions.fromJson(jsonMap["reserveAssumptions"]);

  AssumptionModel._copy(AssumptionModel other) :
    inflation = other.inflation == null? null : other.inflation.copy(),
    balanceSheetAssumptions = other.balanceSheetAssumptions == null? null : other.balanceSheetAssumptions.copy(),
    incomeModelOverrides = valueApply(other.incomeModelOverrides, (v) =>
      v == null? null : v.copy()),
    expenseModelOverrides = valueApply(other.expenseModelOverrides, (v) =>
      v == null? null : v.copy()),
    dateAssumptions = valueApply(other.dateAssumptions, (v) =>
      v == null? null : v.copy()),
    strategyAssumptions = other.strategyAssumptions == null? null : other.strategyAssumptions.copy(),
    taxRateAssumptions = other.taxRateAssumptions == null? null : other.taxRateAssumptions.copy(),
    reserveAssumptions = other.reserveAssumptions == null? null : other.reserveAssumptions.copy();
...
class AssumptionModelBuilder {
  ...
  AssumptionModel buildInstance() => new AssumptionModel(
    inflation, balanceSheetAssumptions, incomeModelOverrides, expenseModelOverrides,
    dateAssumptions, strategyAssumptions, taxRateAssumptions, reserveAssumptions);
